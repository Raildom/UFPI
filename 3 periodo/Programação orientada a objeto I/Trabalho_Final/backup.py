...
#             return False
#         novo_funcionario = FuncionarioRegular(nome, cpf, senha)
...
#         checkin.registrar_hospede(hospede)
...
#     def remover_hospede(self, checkout, cpf):
...
#     def __init__(self):
#         self._hospedes = {}
#         self._quartos_disponiveis = list(range(1, 11))
...
#         return self._quartos_disponiveis
#     @quartos_disponiveis.setter
#     def quartos_disponiveis(self, quartos_disponiveis):
#         self._quartos_disponiveis = quartos_disponiveis

#     def registrar_hospede(self, hospede):
#         if not hospede.cpf.isdigit() or len(hospede.cpf) != 11:
#             print("\nCPF inválido. Deve ser um número de 11 caracteres.")
#             return False
#         if hospede.cpf in self.hospedes:
#             print("\nCPF já cadastrado para outro hóspede.")
#             return False
#         if hospede.quarto in self.quartos_disponiveis:
#             self.hospedes[hospede.cpf] = hospede
#             self.quartos_disponiveis.remove(hospede.quarto)
...
#         self.quartos_disponiveis = ordenar_quartos(self.quartos_disponiveis)
#         print("\nQuartos disponíveis:", self.quartos_disponiveis)


# class CheckOut:
#     def __init__(self):
#         pass
#     def remover_hospede(self, cpf, checkin):
#         if not cpf.isdigit() or len(cpf) != 11:
#             print("\nCPF inválido. Deve ser um número de 11 caracteres.")
#             return False
...
#                         checkout.remover_hospede(cpf, checkin)
...
# class FuncionarioRegular(Funcionario):
#     def registrar_hospede(self, checkin, hospede):
#         if checkin.registrar_hospede(hospede):
#             self.historico.append(f"Hóspede com cpf ({hospede.cpf}) realizou checkin no quarto ({hospede.quarto}).") 
...
#     def remover_hospede(self, checkout, cpf):
#         if checkout.remover_hospede(cpf) == True:
#             self.historico.append(f"Hóspede com cpf ({cpf}) realizou checkout.")
    
#     def imprimir_historico_funcionario_regular(self):
...
#                         checkout.remover_hospede(cpf, checkin)
#                     elif opcao_funcionario == "5":
#                         funcionario.imprimir_historico_funcionario_regular()
