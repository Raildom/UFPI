...
StatusRemocao fundir_com_irmao_esquerdo_45(Arv45 **ponteiro_filho_no_pai, Arv45 *pai, Arv45 *irmao_esq, int pos_filho)
{
    ...
    else
    {
        ...
        { /*fprintf(stderr, "Pos_filho %d invalida em fusao esquerda\n", pos_filho);*/
            return UNDERFLOW;
        } // Early exit mantido por segurança
        pai->nInfo--;
        ...
        // Se fu_fcen1_original (filho direito do nó em underflow) existir, ele idealmente se tornaria o 4º filho.
        // Como um nó de 2 chaves tem 3 filhos, há uma questão de como acomodá-lo.
        // A lógica mais simples é que ele não é diretamente acomodado aqui se os 3 slots já estão preenchidos.
        // Para uma fusão mais robusta que preserve todos os filhos, a estrutura do nó fundido
        // ou a lógica de redistribuição de filhos precisaria ser mais complexa.
        if (irmao_esq->f_cen1 == NULL && fu_esq_original != NULL)
        {                                          // Caso onde f_cen1 original era NULL
