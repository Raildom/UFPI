...
#include "../z_4_5_testes/4_5.h"

// gcc -o teste testes_da_4_5.c ../4_5.c -lm
...
void testar_insercao(Arv45 **raiz, int *valores, int tamanho, char *tipo_vetor)
{
    ...
    printf("\n\n=== TESTE DE INSERCAO NA ARVORE 4-5 COM VETOR %s ===\n\n", tipo_vetor);
    ...
    for (int i = 0; i < tamanho; i++)
    {
        ...
        imprime_arvore_visual_45(*raiz, "", 1, 1); // Corrigido o nome da função
        printf("\n------------------------------------------------\n");
    }
...
void testar_remocao(Arv45 **raiz, int *valores, int tamanho, char *tipo_vetor)
{
    // Preparar nome do arquivo
    char nome_arquivo[50];
    ...
    printf("\n\n=== TESTE DE REMOCAO NA ARVORE 4-5 COM VETOR %s ===\n\n", tipo_vetor);
    ...
    for (int i = 0; i < tamanho; i++)
    {
        ...
        if (remover_45(raiz, valores[i])) // Corrigido o nome da função
        {
...
void testar_impressao(Arv45 *raiz, char *tipo_arvore)
{
    // Preparar nome do arquivo
    char nome_arquivo[50];
    ...
    printf("\n\n=== TESTE DE IMPRESSAO DA ARVORE 4-5 (%s) ===\n\n", tipo_arvore);

    printf("Elementos em ordem: ");
    imprime_45_em_ordem(raiz); // Corrigido o nome da função
    printf("\n\n");
...
void testar_liberacao_tres_arvores(Arv45 **raiz_crescente, Arv45 **raiz_decrescente, Arv45 **raiz_aleatorio)
{
    // Preparar nome do arquivo
    char nome_arquivo[50];
    ...
    printf("\n\n=== TESTE DE LIBERACAO DAS ARVORES 4-5 ===\n\n");
    ...
    if (*raiz_crescente == NULL) {
        ...
        imprime_arvore_visual_45(*raiz_crescente, "", 1, 1); // Corrigido o nome da função
        printf("\n\n");
        printf("Liberando a arvore crescente...\n\n");
        libera_arvore_45(raiz_crescente);
    ...
    if (*raiz_decrescente == NULL) {
        ...
        imprime_arvore_visual_45(*raiz_decrescente, "", 1, 1); // Corrigido o nome da função
        printf("\n\n");
        printf("Liberando a arvore decrescente...\n\n");
        libera_arvore_45(raiz_decrescente);
    ...
    if (*raiz_aleatorio == NULL) {
        ...
        imprime_arvore_visual_45(*raiz_aleatorio, "", 1, 1); // Corrigido o nome da função
        printf("\n\n");
        printf("Liberando a arvore aleatoria...\n\n");
        libera_arvore_45(raiz_aleatorio);
...
void salvar_resultados_combinados(int *vetor_crescente, int *vetor_decrescente, int *vetor_aleatorio, int tamanho)
{
    ...
    // Título geral
    printf("\n\n====================================\n");
    printf("    RESULTADOS COMPLETOS DOS TESTES DA ARVORE 4-5    \n");
    printf("====================================\n\n");
...
int main()
{
    ...
    printf("\n\n====================================\n");
    printf("    INICIANDO TESTES DA ARVORE 4-5    \n");
    printf("====================================\n\n");
    ...
    Arv45 *raiz_crescente = NULL;
    Arv45 *raiz_decrescente = NULL;
    Arv45 *raiz_aleatorio = NULL;

    // Testando operações com árvore vazia
    printf("\n=== TESTE COM ARVORE VAZIA ===\n\n");
    printf("Arvore vazia: ");
    imprime_45_em_ordem(raiz_crescente); // Corrigido o nome da função
    printf("\n\n");
